...
export const weekly: DeliveryPeriodSetData = {
  kpiPeriods: [
    ...
    },
    {
      ...
      revenue: 5156000,
      revenueRegionBadge: "인근매장 평균 대비 +4%",
      revenueDeltaBadge: "전주 대비 +3.4%",
      orders: 289,
      ordersRegionBadge: "인근매장 평균 대비 +1%",
      ordersDeltaBadge: "전주 대비 +9건",
      aov: 17840,
      aovRegionBadge: "브랜드 평균 대비 -2%",
      aovDeltaBadge: "전주 대비 -0.8%",
      cancelRate: 4.1,
      cancelRateRegionBadge: "브랜드 평균 대비 +0.1%p",
      cancelRateDeltaBadge: "전주 대비 +0.2%p",
    ...
    },
    {
      ...
      revenueDeltaBadge: "전주 대비 -2.1%",
      orders: 278,
      ordersRegionBadge: "인근매장 평균 대비 -4%",
      ordersDeltaBadge: "전주 대비 -6건",
      aov: 17942,
      aovRegionBadge: "브랜드 평균 대비 +1%",
      aovDeltaBadge: "전주 대비 +0.5%",
      cancelRate: 3.9,
      cancelRateRegionBadge: "브랜드 평균 대비 -0.2%p",
      cancelRateDeltaBadge: "전주 대비 -0.4%p",
    ...
    },
    {
      ...
      orders: 284,
      ordersRegionBadge: "인근매장 평균 대비 +1%",
      ordersDeltaBadge: "전주 대비 +3건",
      aov: 17937,
      aovRegionBadge: "브랜드 평균 대비 -1%",
      aovDeltaBadge: "전주 대비 -0.2%",
      cancelRate: 4.3,
      cancelRateRegionBadge: "브랜드 평균 대비 +0.3%p",
      cancelRateDeltaBadge: "전주 대비 +0.6%p",
...
export const monthly: DeliveryPeriodSetData = {
  kpiPeriods: [
    ...
    },
    {
      ...
      orders: 1276,
      ordersRegionBadge: "인근매장 평균 대비 +1%",
      ordersDeltaBadge: "전월 대비 -18건",
      aov: 17916,
      aovRegionBadge: "브랜드 평균 대비 -1%",
      aovDeltaBadge: "전월 대비 +0.4%",
      cancelRate: 3.9,
      cancelRateRegionBadge: "브랜드 평균 대비 -0.2%p",
      cancelRateDeltaBadge: "전월 대비 -0.1%p",
    ...
    },
    {
      ...
      revenue: 23240000,
      revenueRegionBadge: "인근매장 평균 대비 +5%",
      revenueDeltaBadge: "전월 대비 +2.9%",
      orders: 1298,
      ordersRegionBadge: "인근매장 평균 대비 +2%",
      ordersDeltaBadge: "전월 대비 +32건",
      aov: 17904,
      aovRegionBadge: "브랜드 평균 대비 -2%",
      aovDeltaBadge: "전월 대비 -0.3%",
      cancelRate: 4.0,
      cancelRateRegionBadge: "브랜드 평균 대비 +0.1%p",
      cancelRateDeltaBadge: "전월 대비 +0.3%p",
